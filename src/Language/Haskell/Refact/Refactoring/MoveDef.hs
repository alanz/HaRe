...
liftToTopLevel :: RefactSettings -> HIE.BiosOptions -> FilePath -> SimpPos -> IO [FilePath]
...
liftOneLevel :: RefactSettings -> HIE.BiosOptions -> FilePath -> SimpPos -> IO [FilePath]
...
demote :: RefactSettings -> HIE.BiosOptions -> FilePath -> SimpPos -> IO [FilePath]
